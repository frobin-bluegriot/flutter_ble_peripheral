#include "include/flutter_ble_peripheral/flutter_ble_peripheral_plugin.h"
...
void FlutterBlePeripheralPlugin::RegisterWithRegistrar(
  ...
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "flutter_ble_peripheral",
...
void FlutterBlePeripheralPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  FlutterBlePeripheralPlugin::RegisterWithRegistrar(
